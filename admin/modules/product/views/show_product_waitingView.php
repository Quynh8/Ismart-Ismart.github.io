...
<div id="main-content-wp" class="list-product-page">
                ...
                <div class="section-detail">
                    <div class="filter-wp clearfix">
                        ...
                        <form method="GET" class="form-s fl-right" >
                            ...
                            <input type="hidden" name="action" value="show_product_publish">
             ...
             <form method="POST" action="" class="form-actions">
                    ...
                    <div class="table-responsive">
                        <table class="table list-table-wp">
                            ...
                            <?php if(!empty($list_product_by_status)){
                               ?>
                               
                               <?php
                               $temp=$start;
                               foreach($list_product_by_status as $item){
                                   $temp ++;
   ...
   //Cần truyền vào hàm tổng số trang,trang hiện tại và đường dẫn mặc định
    echo get_pagging($num_page,$page,"?mod=product&action=show_product_waiting")
   ?>
                </div>
            </div>
        </div>
