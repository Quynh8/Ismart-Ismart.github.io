        ...
        <div id="content" class="fl-right">      
            <div class="section" id="title-page">
                ...
                <?php echo form_error('success'); ?>
                    <h3 id="index" class="fl-left">Sửa thông tin trang</h3>
                </div>
            </div>
            <div class="section" id="detail-page">
                <div class="section-detail">
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <input type="text" name="page_title" id="title" value="<?php if(!empty($item['page_title'])) echo $item['page_title']; ?>">
                        <?php echo form_error('page_title'); ?>
                        <label for="title">Slug ( Friendly_url )</label>
                        <input type="text" name="friendly_url" id="slug" value="<?php if(!empty($item['page_friendly_url'])) echo $item['page_friendly_url']; ?>" >
                        <?php
                        ...
                        <textarea name="page_desc" id="desc" class=""><?php if(!empty($item['page_desc'])) echo $item['page_desc']; ?></textarea>
                        <?php echo form_error('page_desc'); ?>
                        <label for="desc">Nội dung</label>
                        <textarea name="page_content" id="desc" class="ckeditor"><?php if(!empty($item['page_content'])) echo $item['page_content']; ?></textarea>
                        ...
                        <div id="uploadFile">
                            ...
                            <div id="show_list_file">
                                <img src="<?php echo $item['page_thumb'] ?>">
                            </div>
                        </div>
